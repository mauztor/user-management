...
namespace mauztor\modules\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `mauztor\modules\UserManagement\models\UserVisitLog`.
 */
