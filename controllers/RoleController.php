...
class RoleController extends AdminDefaultController
{
	 ...
	 * @var Role
	 */
	public $modelClass = 'mauztor\modules\UserManagement\models\rbacDB\Role';

	/**
	 * @var RoleSearch
	 */
	public $modelSearchClass = 'mauztor\modules\UserManagement\models\rbacDB\search\RoleSearch';
